...
export type SignInFailed = Action<USER_ACTION_TYPES.SIGN_IN_FAILED>;
...
export type SignUpSuccess = 
  ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: UserData, additionalDetails: AdditionalInformation }>;
...
export const googleSignInStart = withMatcher((): GoogleSignIn => createAction(USER_ACTION_TYPES.GOOGLE_SIGN_IN_START));
...
export const signInFailed = withMatcher((): SignInFailed => createAction(USER_ACTION_TYPES.SIGN_IN_FAILED));
